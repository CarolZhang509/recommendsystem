...
class UserCF_demo():
    def __init__(self):
        ...
        self.movies_count = 455691

        self.OUTPUTFILE = './result/userCF.txt'
    ...
    def recommend(self, user):
        ...
        with open(self.OUTPUTFILE, 'a') as file1:
            ...
            for item, score in rank.items():
                if totalSim == 0:
                    print("{} {}".format(item, score), file = file1)
                else:
                    print("{} {}".format(item, score / totalSim), file = file1)
